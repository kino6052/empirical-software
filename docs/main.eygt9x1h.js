...
`}function g(e,t={}){return o(`
  ...
  `),r("p",{class:"text",...t},[e])}function k(e){return o(`
    .nav {
      display: flex;
      gap: 1rem;
      padding: var(--space);
  ...
  `),r("nav",{class:"nav"},e.map((t)=>G(t.text,t.page)))}function E(e,t){return o(`
    .badge {
      display: inline-flex;
      align-items: center;
      gap: 0.4rem;
  ...
  `),r("span",{class:"badge"},[r("span",{class:"badge-emoji"},[e]),r("span",{class:"badge-label"},[t])])}function L(){return o(`
    .divider {
      border: none;
      border-top: 1px solid var(--border);
      margin: calc(var(--space) * 1.5) 0;
    }
  `),r("hr",{class:"divider"})}function P(e={}){return o(`
    .input {
      flex: 1;
  ...
  `),r("input",{class:"input",...e})}function S(e){return o(`
    .grid {
      display: grid;
...
These are not aesthetic questions. They are engineering questions.`}];function F(){o(`
  ...
  `),r("div",{class:"post-meta"},[r("time",{},[e]),r("span",{class:"post-tags"},t.map((n)=>r("span",{class:"tag"},[n])))])}function A(e){return o(`
    .blog-list {
      display: flex;
      flex-direction: column;
      gap: var(--space);
  ...
  `),d([p([c(1,"Blog & Use Cases"),i("Real problems. Real fixes. No fluff."),r("div",{class:"blog-list"},w.map((t)=>O(t,e)))])])}function B(e){return o(`
    .btn-back {
      background: transparent;
      color: var(--muted);
      padding: 0;
...
`).map((n)=>{if(n.startsWith("async function")||n.startsWith("  ")||n.startsWith("await"))return Y(n);return i(n)});return r("article",{class:"post"},[r("div",{class:"post-meta"},[r("time",{},[e.date]),r("span",{class:"post-tags"},e.tags.map((n)=>r("span",{class:"tag"},[n])))]),c(1,e.title),...t])}function I(e){let t=new URLSearchParams(window.location.search).get("slug"),n=w.find((a)=>a.slug===t);if(!n)return d([p([c(1,"Post not found"),B(e)])]);return d([p([B(e),_(n)])])}function $(){o(`
    .contact-form {
      display: flex;
      gap: 0.75rem;
      margin-top: var(--space);
  ...
  `);let e=m(""),t=m(!1),n=y([t],()=>t.get()?"✓ We'll be in touch.":""),a=P({type:"email",placeholder:"your@email.com",oninput:(s)=>{e.set(s.target.value),t.set(!1)}});return r("div",{},[r("div",{class:"contact-form"},[a,g("Send →",{onclick:()=>{if(e.get())t.set(!0),a.value="",e.set("")}})]),r("p",{class:"status-msg"},[n])])}function K(){return o(`
    .contact-alt {
  ...
  `),d([p([r("div",{class:"contact"},[c(1,"Let's talk"),i("No forms. No funnels. Just a conversation about your codebase."),$(),K()])])])}var j={home:(e)=>H(e),services:()=>R(),about:()=>M(),blog:(e)=>A(e),post:(e)=>I(e),contact:()=>N()};function z(e){o(`
    .app {
      min-height: 100vh;
      display: flex;
      flex-direction: column;
  ...
  `);let t=C(),n=k([{text:"Home",page:"home"},{text:"Services",page:"services"},{text:"About",page:"about"},{text:"Blog",page:"blog"},{text:"Contact",page:"contact"}]),a=r("main",{class:"main"});n.addEventListener("click",(l)=>{let f=l.target.getAttribute("data-page");if(f)l.preventDefault(),t.navigate(f)});function s(l){let u=j[l]||j.home;a.innerHTML="",a.appendChild(u((h,W)=>t.navigate(h,W)));let f=l==="post"?"blog":l;n.querySelectorAll("a").forEach((h)=>{h.classList.toggle("active",h.getAttribute("data-page")===f)})}t.onRoute(s),e.appendChild(r("div",{class:"app"},[n,a])),t.start()}var x=document.getElementById("app");if(x)x.innerHTML="",z(x);
